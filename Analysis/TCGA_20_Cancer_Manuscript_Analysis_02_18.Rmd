...
points(jitter(rep(1,12),factor=2),log2(rsem_her2$TCGA_ERBB2[1:12]+1),pch=4,cex=1.5,cex.lab=1.5,col="black")
points(jitter(rep(2,5),factor=2),log2(rsem_her2$TCGA_ERBB2[13:17]+1),pch=4,cex=1.5,cex.lab=1.5,col='black')
points(jitter(rep(3,12),factor=2),log2(rsub_her2$Rsubread_ERBB2[1:12]+1),pch=4,cex=1.5,cex.lab=1.5,col='black')
points(jitter(rep(4,5),factor=2),log2(rsub_her2$Rsubread_ERBB2[13:17]+1),pch=4,cex=1.5,cex.lab=1.5,col='black')
