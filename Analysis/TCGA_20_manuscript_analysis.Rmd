...
We calculate the number of zero values per sample across the TCGA data set.

Moom: mention the script that you used to generate these files.
...
We used Random Forests regression to predict lung-cancer type based on RNA-Seq data.
...
# Moom: please state briefly what this function does
