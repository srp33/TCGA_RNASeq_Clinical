...
setwd("TCGA_RNASeq_Clinical/Analysis_datasets/")##update
...
tcga20_tpm<-data.frame(fread("PANCAN20.IlluminaHiSeq_RNASeqV2.tumor_Rsubread_TPM_10_9.txt"),row.names=1,check.names = F)#Download it from GEO#GSE62944
rsem_12<-data.frame(fread("PANCAN12.IlluminaHiSeq_RNASeqV2.geneExp.tumor_whitelist"),row.names=1,check.names = F)#PANCAN12 dataset downloaded from Synapse
